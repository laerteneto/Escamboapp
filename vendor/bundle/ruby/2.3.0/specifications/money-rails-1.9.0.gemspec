# -*- encoding: utf-8 -*-
# stub: money-rails 1.9.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<money>, ["~> 6.9.0"])
      s.add_runtime_dependency(%q<monetize>, ["~> 1.7.0"])
      ...
      s.add_dependency(%q<money>, ["~> 6.9.0"])
      s.add_dependency(%q<monetize>, ["~> 1.7.0"])
